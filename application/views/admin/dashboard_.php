  ...
  <section id="container" >
                      ...
                      <!-- SERVER STATUS PANELS -->
                      	...
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
										<img src="<?=base_url()?>assets/admin/img/product.png" width="120">
	                      		</div>
                      		</div>
                      	</div><!-- /col-md-4 -->
						...
						<div class="col-md-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="<?=base_url()?>assets/admin/img/ui-zac.jpg" class="img-circle" width="80"></p>
								<p><b>Zac Snider</b></p>
								<div class="row">
									<div class="col-md-6">
      ...
      *********************************************************************************************************************************************************** -->                  
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?=base_url()?>assets/admin/img/ui-divya.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?=base_url()?>assets/admin/img/ui-sherman.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?=base_url()?>assets/admin/img/ui-danro.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?=base_url()?>assets/admin/img/ui-zac.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="<?=base_url()?>assets/admin/img/ui-sam.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            image: '<?=base_url()?>assets/admin/img/ui-sam.jpg',
