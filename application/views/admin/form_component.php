...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/admin/js/bootstrap-datepicker/css/datepicker.css" />
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/admin/js/bootstrap-daterangepicker/daterangepicker.css" />
  ...
  <section id="container" >
	...
	<script type="text/javascript" src="<?=base_url()?>assets/admin/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="<?=base_url()?>assets/admin/js/bootstrap-daterangepicker/date.js"></script>
	<script type="text/javascript" src="<?=base_url()?>assets/admin/js/bootstrap-daterangepicker/daterangepicker.js"></script>
	
	<script type="text/javascript" src="<?=base_url()?>assets/admin/js/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>
